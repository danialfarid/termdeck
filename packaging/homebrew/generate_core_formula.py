...
class CoreFormulaGenerator:
    PYTHON_VERSION = (3, 14)
    RELEASE_URL = "https://github.com/danialfarid/termdeck/releases/download/v{version}/termdeck_agents-{version}.tar.gz"
    PYPI_URL = "https://pypi.org/pypi/{name}/{version}/json"
    PROVIDED_PACKAGES = frozenset({"termdeck-agents", "certifi", "pydantic", "pydantic-core", "annotated-types",
