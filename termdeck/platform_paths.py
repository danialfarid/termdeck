...
class PlatformPaths:
    ...
    ENV_LAN_PORT = "TERMDECK_LAN_PORT"
    ...
    ENV_GH_BIN = "TERMDECK_GH_BIN"
    ENV_CODEX_BIN = "TERMDECK_CODEX_BIN"
    ENV_CLAUDE_BIN = "TERMDECK_CLAUDE_BIN"
    ENV_MUSE_BIN = "TERMDECK_MUSE_BIN"
