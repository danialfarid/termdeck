...
const TERMINAL_TYPE_SVGS = {
  claude: '<svg viewBox="0 0 16 16" aria-hidden="true"><rect x="0.65" y="0.65" width="14.7" height="14.7" rx="3" fill="#0a0c10"/><g fill="none" stroke="#fff" stroke-width="1.05" stroke-linecap="round"><path d="M8 1.95v3.15M8 10.9v3.15M1.95 8H5.1M10.9 8h3.15M3.72 3.72l2.23 2.23M10.05 10.05l2.23 2.23M12.28 3.72l-2.23 2.23M5.95 10.05l-2.23 2.23"/></g><circle cx="8" cy="8" r="1.35" fill="#fff"/></svg>',
