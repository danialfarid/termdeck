...
TERMINAL_TYPE_SVGS.codex = '<svg viewBox="0 0 16 16" aria-hidden="true"><defs><linearGradient id="codex-gradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0" stop-color="#8df1ce"/><stop offset=".35" stop-color="#9fc8ff"/><stop offset=".62" stop-color="#f2a8dd"/><stop offset=".82" stop-color="#f6df87"/><stop offset="1" stop-color="#9be7c5"/></linearGradient></defs><path fill="#0b0d17" d="M8 .55 14.45 4.2v7.6L8 15.45 1.55 11.8V4.2Z"/><g fill="none" stroke="url(#codex-gradient)" stroke-width="1.05" stroke-linecap="round" stroke-linejoin="round"><path d="M2.35 5.05 6.55 2.65q1.45-.82 2.9 0l4.2 2.4"/><path d="M2.35 6.55 6.55 4.15q1.45-.82 2.9 0l4.2 2.4"/><path d="M2.35 8.05 6.55 5.65q1.45-.82 2.9 0l4.2 2.4-4.2 2.4q-1.45.82-2.9 0l-4.2-2.4"/><path d="M2.35 9.55 6.55 11.95q1.45.82 2.9 0l4.2-2.4"/><path d="M2.35 11.05 6.55 13.45q1.45.82 2.9 0l4.2-2.4"/></g></svg>';
