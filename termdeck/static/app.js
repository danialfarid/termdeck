...
const FALLBACK_ICON_SVGS = {
  ...
  muse: '<svg viewBox="0 0 32 32" aria-hidden="true"><path fill="currentColor" d="M10.5119 6.03125C10.5023 6.03125 10.4927 6.03128 10.4831 6.03133L10.4436 9.28995C10.4526 9.28986 10.4616 9.28978 10.4707 9.28978H10.4707C12.6156 9.28978 14.2792 10.9809 17.8952 17.0717L18.1157 17.4425L18.1301 17.4668L20.1543 14.4297L20.1403 14.4062C19.6639 13.6315 19.2062 12.9186 18.7673 12.2677C18.2583 11.5135 17.7715 10.8397 17.2991 10.2382C14.907 7.19246 12.906 6.03125 10.5119 6.03125Z"/><path fill="currentColor" d="M10.4832 6.03133C8.07758 6.04371 5.95081 7.5993 4.4151 9.97968C4.4106 9.98665 4.40611 9.99363 4.40161 10.0006L7.22059 11.5349C7.22516 11.528 7.22976 11.5211 7.23436 11.5142C8.13112 10.164 9.24711 9.30277 10.4438 9.28995C10.4528 9.28986 10.4618 9.28978 10.4709 9.28978L10.5121 6.03125C10.5025 6.03125 10.4929 6.03128 10.4832 6.03133Z"/><path fill="currentColor" d="M4.41535 9.98047C4.41086 9.98744 4.40636 9.99442 4.40187 10.0014C3.39273 11.5723 2.64046 13.5 2.2339 15.5796C2.23214 15.5886 2.23039 15.5976 2.22864 15.6066L5.39564 16.3538C5.3973 16.3448 5.39896 16.3358 5.40063 16.3267C5.73914 14.4991 6.38363 12.8041 7.22083 11.5357C7.2254 11.5288 7.23 11.5219 7.2346 11.515L4.41535 9.98047Z"/><path fill="currentColor" d="M5.40046 16.3253L2.23373 15.5781C2.23197 15.5871 2.23021 15.5961 2.22846 15.6052C2.00677 16.7488 1.89399 17.911 1.89162 19.0759C1.89161 19.0853 1.8916 19.0948 1.8916 19.1042L5.13949 19.3947C5.13923 19.3853 5.13896 19.376 5.13874 19.3665C5.13715 19.2989 5.13634 19.2304 5.13631 19.161C5.13793 18.2189 5.22467 17.2789 5.39547 16.3524C5.39712 16.3434 5.39879 16.3343 5.40046 16.3253Z"/><path fill="currentColor" d="M5.23828 20.4083C5.18002 20.0735 5.147 19.7348 5.13949 19.395C5.13923 19.3855 5.13896 19.3762 5.13874 19.3667L1.89162 19.0762C1.89161 19.0856 1.8916 19.095 1.8916 19.1044V19.1063C1.8916 19.8313 1.95207 20.5101 2.06958 21.1373C2.07127 21.1463 2.07294 21.1552 2.07467 21.1643L5.24319 20.4354C5.24152 20.4264 5.2399 20.4174 5.23828 20.4083Z"/><path fill="currentColor" d="M5.97788 22.0873C5.62446 21.7015 5.37433 21.145 5.24283 20.4334C5.24117 20.4244 5.23955 20.4153 5.23793 20.4062L2.06921 21.1352C2.07091 21.1443 2.07258 21.1532 2.07431 21.1622C2.31381 22.4197 2.78352 23.4677 3.45618 24.2605C3.46216 24.2676 3.46816 24.2746 3.47418 24.2816L5.99676 22.1076C5.99045 22.1009 5.98413 22.0941 5.97788 22.0873Z"/><path fill="currentColor" d="M15.
.0378 30.6128 24.0003 30.6389 23.9621C30.6573 23.9351 30.6755 23.9079 30.6934 23.8805C30.6987 23.8725 30.7039 23.8644 30.7092 23.8563L28.5715 21.6328Z"/><path fill="currentColor" d="M26.7913 22.7234C26.4648 22.7234 26.1767 22.6748 25.8948 22.5488L24.8978 25.6905C25.4582 25.8819 26.0559 25.9682 26.7225 25.9682C27.3367 25.9682 27.9005 25.8762 28.4116 25.6991L27.4381 22.6315C27.2283 22.6944 27.0103 22.7254 26.7913 22.7234V22.7234Z"/><path fill="currentColor" d="M24.7959 21.6464C24.7897 21.6393 24.7836 21.6322 24.7774 21.625L22.4834 24.0108C22.4898 24.0177 22.4962 24.0246 22.5026 24.0314C23.2998 24.8808 24.0609 25.4078 24.9241 25.697L25.9203 22.5577C25.5565 22.4014 25.2047 22.1182 24.7959 21.6464Z"/><path fill="currentColor" d="M24.7774 21.6268C24.0893 20.8266 23.2381 19.4942 21.8991 17.3398L20.1542 14.4297L20.1402 14.4062L18.1156 17.4426L18.13 17.4668L19.3664 19.5467C20.5648 21.5522 21.5412 23.003 22.4834 24.0126C22.4898 24.0195 22.4962 24.0263 22.5026 24.0331L24.7958 21.6482C24.7897 21.6411 24.7836 21.634 24.7774 21.6268Z"/></svg>',
};
const AGENT_SPEC_DEFAULTS = {
  ...
  agy: { kind: "agy", label: "AGY", is_agent: true, prompt_marker: "", icon_svg: FALLBACK_ICON_SVGS.agy,
    permissions: [{ value: "default", label: "Default" }, { value: "accept-edits", label: "Accept edits" },
      { value: "plan", label: "Plan" }, { value: "sandbox", label: "Sandbox" }, { value: "full-access", label: "Full access" }],
    ...
    model_help: "A trailing low, medium, or high value sets AGY reasoning effort.", activity_source: "transcript",
    records_raw_replay: false, has_prompt_queue: false, transcript_commands: [] },
  muse: { kind: "muse", label: "Muse", is_agent: true, prompt_marker: "", icon_svg: FALLBACK_ICON_SVGS.muse,
    ...
    records_raw_replay: true, has_prompt_queue: false,
    transcript_commands: [{ command: "/model", description: "Change the active model" },
      { command: "/help", description: "Show Muse commands" }] },
  aider: { kind: "aider", label: "Aider", is_agent: true, prompt_marker: "", icon_svg: FALLBACK_ICON_SVGS.aider,
    ...
    activity_source: "terminal-output", records_raw_replay: false, has_prompt_queue: false,
    transcript_commands: [{ command: "/model", description: "Switch the active model" },
      { command: "/tokens", description: "Show context token usage" },
      { command: "/undo", description: "Undo the latest Aider commit" },
      { command: "/help", description: "Show Aider commands" }] },
  opencode: { kind: "opencode", label: "OpenCode", is_agent: true, prompt_marker: "┃", icon_svg: FALLBACK_ICON_SVGS.opencode,
    permissions: [{ value: "default", label: "Default (confirm actions)" }, { value: "auto", label: "Auto-approve" }],
    ...
    activity_source: "session-database+terminal-output", records_raw_replay: true, has_prompt_queue: false,
    transcript_commands: [{ command: "/models", description: "Choose a provider and model" },
      { command: "/connect", description: "Configure a model provider" },
      { command: "/sessions", description: "Switch OpenCode sessions" },
