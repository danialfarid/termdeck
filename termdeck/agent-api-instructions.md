...
GET /api/sessions/{session_id}/last-turns?since=<since> until turns is not empty: those
are the answers to that prompt. Follow up via POST /api/sessions/{session_id}/prompt
