        ...
        for line in lines:
            ...
            if isinstance(content, str):
                ...
                if normalized_content.strip():
                    turns.append(TurnBuilder.turn(role, normalized_content, model=model, timestamp=timestamp))
                ...
                for block in content:
                    ...
                    if block_type == "text":
                        ...
                        if text.strip():
                            turns.append(TurnBuilder.turn(role, text, model=model, timestamp=timestamp))
                    elif block_type == "tool_use":
                        turns.append(TurnBuilder.tool_event(str(block.get("name", "tool")), block.get("input", {}),
